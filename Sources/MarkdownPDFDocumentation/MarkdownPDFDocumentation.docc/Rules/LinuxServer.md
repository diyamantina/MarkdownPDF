...
Operational rules for MarkdownPDF code that runs on Linux in production: HTTP client, logging, database, crypto, signals, resources, POSIX interop, file I/O, and Docker CI.
...
public final class MarkdownPDFloader: @unchecked Sendable {
...
let baseProducts: [Product] = [
    .singleTargetLibrary("MarkdownPDF"),
...
let appleOnlyProducts: [Product] = [
    .singleTargetLibrary("MarkdownPDFUI"),
    .singleTargetLibrary("MarkdownPDFComponents"),
    // ... Apple-only UI
]
#else
let appleOnlyProducts: [Product] = []
